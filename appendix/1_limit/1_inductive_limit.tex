...
\Definition{(帰納系の定義)\\
  ...
  次を満たすとき,$\{X_{\lambda},\varphi_{\mu,\lambda}\}$を
  \index{きのうけい/じゅんけい@帰納系/順系}\index{inductive system/direct system}
  \textbf{順系(direct system)}または
...
\Definition{(帰納系の射の定義)\\
  \index{きのうけい/じゅんけい@帰納系/順系!のしゃ@の射}\index{inductive system/direct system!morphism}
...
\Definition{
  ...
  $\mathscr{C}$の帰納系とする.\\
  このとき$\{X_{\lambda},\varphi_{\mu,\lambda}\}$の
  \index{きのうきょくげん/じゅんきょくげん@帰納極限/順極限}\index{inductive limit/direct limit}
  \textbf{順極限(direct limit)}または\textbf{帰納的極限(inductive limit)}または\textbf{帰納極限}とは,
