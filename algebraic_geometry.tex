...
\Lemma{
  ...
  すると$V\subset X \mysetminus V(\mathcal{J})$となって$X\mysetminus V(\mathcal{J})$が開であることがわかる。\\
  また、任意の$x\in V(\mathcal{J})$に対して
  \begin{equation*}
...
\Proposition{
  ...
  \begin{equation*}
    0 \longrightarrow \mathcal{J} \longrightarrow \mathcal{O}_{X} \longrightarrow f_{*}\mathcal{O}_{X} \longrightarrow 0
  \end{equation*}
  $V(\mathcal{J}) = f(Y)$から
  \begin{equation*}
