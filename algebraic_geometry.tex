...
まず次の完全列
  ...
  \end{equation*}
  からProp:\ref{Prop:1.3.11}より任意の$y = f(x) \in Y$に対して
  \begin{equation*}
    \mathcal{O}_{Y,y}/\mathcal{J}_{y} = (f_{*}\mathcal{O}_{X})_{y} = \mathcal{O}_{X,x}
  \end{equation*}
  を得る。よって
  \begin{equation*}
    ...
    \begin{alignedat}{2}
      ...
      &\mathcal{O}_{X,x} \qquad &y& \in V(\mathcal{J}),y=f(x)
    \end{alignedat}
    \right.\qquad \cdots (*)
  \end{equation*}
